...
* Безопасность: Для публичных бакетов использую политики вместо ACL в реальных проектах, чтобы избежать утечек. Слежу за расходами в AWS.
* Масштаб: S3 держит огромные объёмы данных с высокой надёжностью. Для больших файлов — использую multipart-загрузку.
...
* Альтернативы: Для динамики — не S3, а EC2 или Amplify. В PHP добавил проверки файлов для безопасности.
