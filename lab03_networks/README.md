...
Не смог выполнить, так как по текущим правилам безопасности (из задания) db-sg-k21 впускает MySQL(3306) только от web-sg-k21. Бастион не входит в этот SG, поэтому mysql -h 10.22.2.201 с бастиона не пройдёт — и это правильно с точки зрения безопасности.
